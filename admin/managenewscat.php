...
if(isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
	...
	$query = "SELECT * FROM news_categories WHERE cat_id LIKE '%$search_text%' OR category_name LIKE '%$search_text%' ORDER BY cat_id DESC ";
} else {
	$query = "SELECT * FROM news_categories order by cat_id DESC ";
}
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <a class="btn btn-border dark" href="deletenewscat.php?action=view&id=<?php echo $row['news_id']; ?>"><span> Delete</span></a></td>
                                        </tr>
