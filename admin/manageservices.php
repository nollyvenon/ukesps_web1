...
if(isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
	...
	$query = "SELECT * FROM services WHERE id LIKE '%$search_text%' OR page_title LIKE '%$search_text%'  ORDER BY id DESC ";
} else {
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo limit_text($row['info'], $limit); ?></td>
                                            <td><!--<a class="btn btn-border green" href="updatenews.php?action=view&id=<?php echo $row['testi_id']; ?>"><span> Update</span>--></a>
                                            <a class="btn btn-border dark" href="deleteservices.php?action=view&id=<?php echo $row['id']; ?>"><span> Delete</span></a></td>
                                        </tr>
