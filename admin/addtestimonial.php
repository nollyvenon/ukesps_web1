...
if (isset($_POST['addtesti']) && !empty($_POST['addtesti'])) {
    ...
    if(empty($quote_writer) || empty($quote)) {
        ...
        $result = $bio_operation->addtestimonial($quote_writer, $quote, $quote_location);
        if($result) {
             $message_success = $result;
        } else {
            $message_error = "Testimonial was not successfully added.";
        }
    }
}
?><!DOCTYPE HTML>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="name">
                                Full Name</label>
                            <input name="quote_writer" type="text" id="quote_writer" value="<?php $quote_writer; ?>" size="73" />
                        </div>
                        <div class="form-group">
                            <label for="position">
                                Testimony</label>
                            <input name="quote" type="text" id="quote" value="<?php $quote; ?>" size="73" />
                        </div>
                        <div class="form-group">
                            <label for="position">
                                Location</label>
                            <input name="quote_location" type="text" id="quote_location" value="<?php $quote_location; ?>" size="73" />
                        </div>
                    <div class="col-md-12">
                            <input type="submit" class="btn btn-primary" name="addtesti"  value="Add Testimonial" />
