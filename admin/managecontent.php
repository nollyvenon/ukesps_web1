...
if(isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
	...
	$query = "SELECT * FROM content WHERE title LIKE '%$search_text%' OR info LIKE '%$search_text%' OR entrydate LIKE '%$search_text%' ORDER BY id DESC ";
} else {
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-border green" href="updatecontent.php?action=view&id=<?php echo $row['id']; ?>"><span> Update</span></a>
                                            <a class="btn btn-border dark" href="deletecontent.php?action=view&id=<?php echo $row['id']; ?>"><span> Delete</span></a></td>
                                        </tr>
