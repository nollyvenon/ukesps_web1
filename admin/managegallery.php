...
if(isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
	...
	$query = "SELECT * FROM gallery WHERE title LIKE '%$search_text%' OR picture LIKE '%$search_text%' ORDER BY id DESC ";
} else {
...
<?php include('header.php');?>			<div class="bg-wrapper aout-page">
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="../img/gallery/<?php echo $row['picture'];?>" width=100 height=100></td>
		...
		<script src="../js/func.js"></script>	</body>
</html>
