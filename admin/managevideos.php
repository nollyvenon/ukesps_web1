...
if(isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
	...
	$query = "SELECT * FROM videos WHERE title LIKE '%$search_text%' OR video LIKE '%$search_text%' ORDER BY video_id DESC ";
} else {
...
<?php include('header.php');?>			<div class="bg-wrapper aout-page">
	...
	<source src="videos/<?php echo $row['video'];?>" type="video/mp4">
                                            ...
                                            <td><a class="btn btn-border dark" href="deletevideo.php?action=view&id=<?php echo $row['video_id']; ?>"><span> Delete</span></a></td>
                                        </tr>
