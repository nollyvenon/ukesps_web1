...
xmlhttp.send();
		...
		<div class="row mb-3" style="padding:10px	">
		  <div class="col-md-5">Job Category <select name="job_category"
		  onfocus="ShowSubCategories(this.value)" onchange="ShowSubCategories(this.value)"
		   data-required="true" class="selectpicker" data-live-search= "true">
