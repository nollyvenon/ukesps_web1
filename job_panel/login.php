	...
	<section class="fullwidth-background bg-2">
		<div class="grid-row">
			<div class="login-block">
				...
				<div class="login-or">
					<hr class="hr-or">
					<span class="span-or">Job Seeker Login</span>
					<hr class="hr-or">
				</div>
				<form action="" id="login" method="post" class="form-horizontal tasi-form" name="login" enctype="multipart/form-data">
					...
					<p class="small">
						<a href="<?= SITE_URL ?>/job_panel/forgot_password">Forgot Password?</a>
					</p>
					...
					<br><br>
					<span class="text-right"><a href="<?= SITE_URL ?>/job_panel/register" class="cws-button bt-color-2 border-radius">Register</a></span>
				</form>
