...
<body>
    ...
    <div class="container">
	  ...
	  <div class="form-group row">
		...
		$cat_info = "<div class=\"grid-col grid-col-12 grid-col-row clear-fix\">";
			if(isset($content1) && !empty($content1)) { foreach ($content1 as $row) { 
			$sl_id = $row['sl_id'];
			$sl_name = $row['sl_name'];
			$cat_info .= "<div style=\"height:50px;\" class=\"columns-col columns-col-2 \">
						<div class=\"checkbox\">
	  ...
	  <div class="form-group row">
		...
		$cat_info .= "</div>";
		  ...
		  <br><br><br>
		 <div class="form-group row mt3 ml-4">   <div class=""> <button type="submit" name="search2" class="cws-button  border-radius alt">Search</button></div>
		  </div>
