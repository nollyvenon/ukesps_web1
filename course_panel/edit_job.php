...
if (isset($_POST['update_job']) && !empty($_POST['update_job'])) {
    ...
    if(empty($course_title) || empty($location) || empty($description)) {
        ...
        $result = $zenta_operation->update_job($job_title, $course_prov_code, $email, $phone, $gallery, $job_company,  $location_id, $country_id, $startDate, $endDate, $category_id, $sub_category_id, $jobstype, $joblevel, $jobsector, $description);
        if($result) {
       ...
       <form action="" method="post" class="form-horizontal tasi-form" enctype="multipart/form-data">
         <div class="form-group">
         	<label class="col-md-4">
              ...
              <div class="col-md-10 col-xs-11"><input name="course_prov_code"  class="form-control" type="hidden" id="course_prov_code" size="30" value="<?php echo $course_provider_id;?>" /></div>
          </div>
		...
		<div class="form-group">
			...
			<div class="form-group">
              ...
              <div class="col-md-10 col-xs-11"><div id="txtHint1"><select name="sub_category_id" data-required="true" class="selectpicker" data-live-search= "true">
