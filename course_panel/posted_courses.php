...
if (isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
	...
	WHERE cou.course_prov_code='$course_prov_code' AND (cou.course_title LIKE '%$search_text%' OR jc.category_name LIKE '%$search_text%' OR jsc.category_name LIKE '%$search_text%' OR jlo.location LIKE '%$search_text%' OR stm.sm_name LIKE '%$search_text%') ORDER BY course_id DESC ";
} else {
	...
	INNER JOIN course_sub_categories jsc ON cou.course_subcategory=jsc.subcat_id
	INNER JOIN institutions inst ON cou.course_institute=inst.institute_id 
	INNER JOIN course_study_methods stm ON cou.study_method=stm.csm_id WHERE cou.course_prov_code='$course_prov_code' ORDER BY course_id DESC ";
}
