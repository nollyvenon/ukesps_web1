...
$customer_email = $_SESSION['event_prov_email'];
...
$currency = $event_prov_object->get_cart_info($ssid)['paymentmode'];
...
//create transaction
$callback_url = SITE_URL . '/events/paystack_payment_verification';
