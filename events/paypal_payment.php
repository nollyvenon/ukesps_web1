...
<body class="shop">
	...
	<div class="page-content woocommerce">
		<div class="container clear-fix">
			<div class="grid-col-row">
				<div class="grid-col grid-col-9">
                    ...
                    <div class="container">
                      <div class="row">
                        <div class="col-sm-8">
                              <?php echo $event_prov_object->recruiting_plan_detail_by_id(['pid'])['plan_name'];?>
                        </div>
                        <div class="col-sm-2">
            ...
            <?php if(isset($cart_info) && !empty($cart_info)) { foreach ($cart_info as $row) {   ?>
            <input type='hidden' name='item_name' value='<?php echo $event_prov_object->recruiting_plan_detail_by_id(['pid'])['plan_name'];?>'> 
