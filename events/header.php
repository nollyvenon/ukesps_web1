	...
	<div class="page-header-top">
		<div class="grid-row clear-fix">
			...
			<div class="header-top-panel">
				...
				<a href="<?= SITE_URL ?>/events/cart" class="fa fa-shopping-cart"><sup></sup></a>
				<?= isset($_SESSION['event_prov_last_name']) ? '<a href="logout" class="fa fa-user login-icon"></a>' : '<a href="login" class="fa fa-user login-icon"></a>' ?>
			...
			<div class="grid-row clear-fix">
				...
				<nav class="main-nav">
					<ul class="clear-fix">
						...
						<li><a href="<?= SITE_URL ?>/event" class="active">Events</a></li>
		...
		<div class="grid-row clear-fix">
			<nav class="footer-nav">
				<ul class="clear-fix">
					...
					<li class="entry-nav">
						<a href="add_event">Post Events</a>
					</li>
					<li class="entry-nav">
					...
					<?php if (isset($_SESSION['event_prov_last_name'])) : ?>
						<li class="entry-nav">
