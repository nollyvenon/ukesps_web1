...
<body class="shop">
	...
	<div class="page-content woocommerce">
		<div class="container clear-fix">
			<div class="grid-col-row">
				<div class="grid-col grid-col-9">
                    ...
                    <!--<div class="container">
                      <div class="row">
                        <div class="col-sm-8">
                              <?php echo $zenta_operation->get_course_by_id($row['pid'])['course_title'];?>
                        </div>
                        <div class="col-sm-2">
            ...
            <?php if(isset($cart_info) && !empty($cart_info)) { foreach ($cart_info as $row) {   
						 $course_info = $zenta_operation->get_course_by_id($row['pid']);
						 $course_title = $course_info['course_title'];
						 $course_currency = $course_info['course_currency'];
						 $currency_code = $zenta_operation->get_currency_info($course_currency)['currency_code'];
	?>
            <input type='hidden' name='item_name' value='<?php echo $zenta_operation->get_course_by_id($row['pid'])['course_title'];?>'> 
            ...
            <?php }}?>
            <input type='hidden' name='notify_url' value='https://<?=$_SERVER[HTTP_HOST];?>/notify.php'>
            <input type='hidden' name='cancel_return' value='https://<?=$_SERVER[HTTP_HOST];?>/cancel.php'>
            <input type='hidden' name='return' value='https://<?=$_SERVER[HTTP_HOST];?>/return.php'>
            <input type="hidden" name="cmd" value="_xclick"> 
			<center><input type="submit" class="cws-button bt-color-3" name="pay_now" id="pay_now" Value="Pay Now"></center>
        </form>
				</div>
