		...
		<div class="col-lg-6 col-md-6">
			<?php foreach ($banners as $banner) : ?>
				<?php if ($banner['position'] == 'footer_banner_1') : ?>
					<div class="banner banner-foot"><a href="<?= $banner['banner_url'] ?>"><img style="height: auto; width: 100%; max-height:100px" src="<?= SITE_URL ?>/img/banners/<?= $banner['image'] ?>" alt="" /></a></div>
				<?php endif ?>
			<?php endforeach ?>
