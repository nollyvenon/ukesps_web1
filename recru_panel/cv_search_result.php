                    ...
                    <?php include_once("../layouts/feedback_message.php");?>
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><input class="form-check-input" type="checkbox" id="select_appl" value="<?php echo $row['applicant_code']; ?>" name="select_appl[]"></td>
                                            ...
                                            <td><a class="btn btn-border green" title="Applicant Details" href="application_det?hiss=<?php echo encrypt($row['appl_id']); ?>"><span> <i class="fa fa-briefcase"></i></span></a>
												...
												<a href=\"#myModal\" class=\"\" title="Contact Applicant" data-toggle=\"modal\" data-id=\"<?php echo $applicant_code;?>\"><i class="fa fa-compass"></i></a>
											</td>
                                        </tr>
		  ...
		  <div class="col-md-12 col-sm-12 col-xs-12 mail_view_info">
                ...
                <div class="form-group mail_cc_bcc">
					...
					<div class="form-group">
						<p>Mailing List</p>
						<table class="table table-responsive table-striped table-bordered table-hover">
						<?php if(isset($applic_list) && !empty($applic_list)) { foreach ($applic_list as $row) { ?>
                          <tr>
