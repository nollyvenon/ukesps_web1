...
//		$uploaddir = "../images/siteads/";
		...
		if ($message_error == ''){
			...
			$result = $zenta_operation->add_job($job_title, $recruiter_code, $email, $phone, $location_id, $country_id, $startDate, $endDate, $category_id, $sub_category_id, $jobstype, $joblevel, $jobsector, $description);
			if($result) {
