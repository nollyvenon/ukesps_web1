<div class="grid-col grid-col-3 sidebar">
					...
					<aside class="widget-instructor">
						...
						<aside class="widget-categories">
                            ...
                            <ul>
                                ...
                                <li class="cat-item cat-item-1 current-cat"><a href="applications">View applications </span></a></li>
                                <li class="cat-item cat-item-1 current-cat"><a href="posted_jobs">View Posted Jobs</a></li>
                                <li class="cat-item cat-item-1 current-cat"><a href="add_job">Add Jobs <span> (14) </span></a></li>
						...
						?>
							<div class="popular-item">
								...
								<div class="course-date bg-color-1 clear-fix">
									<div class="day"><i class="fa fa-calendar"></i><?php echo date('d, F', $timestamp); ?></div><div class="time"><i class="fa fa-clock-o"></i>At <?php echo date('h:i a', $timestamp); ?></div>
								</div>
							</div>
							<?php }} ?>
						</div>
					...
					<aside class="widget-comments">
						...
						<div class="comments">
							...
							if(isset($course_comments) && !empty($course_comments)) { foreach ($course_comments as $row) { 
							...
							<div class="comment">
								<div class="header-comments">
									<div class="date"><?php echo date('d.m.Y', strtotime($timestamp)); ?> /</div>
