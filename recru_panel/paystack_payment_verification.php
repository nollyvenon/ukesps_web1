...
if ('success' == $tranx->data->status) {
	...
	$payment = $recruit_object->paystack_payment($recruiter_code, $_GET['reference'], $_GET['trxref'], '1', $amount, $_SESSION['recruit_email'], $_SESSION['unique_id'], $payment_category, $currency, $_SESSION['plan_id']);
	//redirect to a thank you page
	header('Location: paystack_thank_you.php');
} else {
	//mysql_query("DELETE FROM carrrt WHERE code='$unique'");
