...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['recaptcha_response'])) {
	...
	if ($recaptcha->score >= 0.5) {
		...
		if ($message_error == '') {
			...
			$result = $zenta_operation->new_user($last_name, $middle_name, $first_name, $gender_select, $email, $phone, $password, $country, $source, $mailing_address, $courses, $universities);
			if ($result) {
				...
				<?php if ($message_success == "") { ?>
					<form action="" method="post" class="form-horizontal tasi-form" name="searchmereg" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-11 col-xs-11"><input name="password" required class="form-control" type="password" id="password" size="30" /></div>
						</div>
						...
						<div class="form-group ">
							...
							<div class="col-md-11 col-xs-11 message-form-message">
								<textarea name="mailing_address" cols="45" rows="8" class="form-control" aria-required="true"></textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-11 col-xs-11 message-form-message ">
								<textarea name="courses" cols="45" rows="8" aria-required="true" class="form-control"></textarea>
							</div>
						</div>

						<div class="form-group">
							<label class="col-md-9">University Preferences:</label>
							<div class="col-md-11 col-xs-11 message-form-message"><textarea class="form-control" name="universities" cols="45" rows="8" aria-required="true"></textarea></div>
						</div>
