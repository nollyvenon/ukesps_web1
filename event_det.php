				...
				<main>
					<div class="blog-post"><article>
						<div class="post-info clear-fix">
							<div class="date-post"><div class="day"><?= date('d', strtotime($startDate));?></div><div class="month"><?= date('M', strtotime($startDate));?></div></div>
						...
						<div class="blog-media picture">
							...
							<div class="link-cont">
								...
								<a href="img/<?=$event_img;?>" class="fancy fa fa-search"></a>
								<a href="#" class="cws-right fa fa-heart"></a>
							</div>
							<img src="img/<?=$event_img;?>" class="columns-col-12" alt>
						</div>
						<h2><?=$event_title;?></h2>
