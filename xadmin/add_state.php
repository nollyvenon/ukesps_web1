...
if (isset($_POST['add_state']) && !empty($_POST['add_state'])) {
    ...
    if(empty($state_name)) {
        ...
        $result = $zenta_operation->add_state($state_name, $country_id, $admin_id);
        if($result) {
             $message_success = "State was added successfully.";
        } else {
            $message_error = "State was not added successfully.";
        }
    }
}
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                 							<?php include_once('views/add_state.php');?>
                                                        </div>
                                                    </div>
                                                </div>
