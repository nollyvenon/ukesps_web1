...
if(isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
	...
	$query = "SELECT * FROM vacancies WHERE job_id LIKE '%$search_text%' OR job_name LIKE '%$search_text%' ORDER BY job_id DESC ";
} else {
	$query = "SELECT * FROM vacancies order by job_id DESC ";
}
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo truncate_str($row['job_details'], 40); ?></td>
											<td><?php echo date('d M, Y',strtotime($row['avail_till'])); ?></td>
                                            <td><!--<a class="btn btn-border green" href="updatenews.php?action=view&id=<?php echo $row['testi_id']; ?>"><span> Update</span>--></a>
                                            <a class="btn btn-border dark" href="deletevacancy.php?action=view&id=<?php echo $row['job_id']; ?>"><span> Delete</span></a></td>
                                        </tr>
