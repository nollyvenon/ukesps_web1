...
if (isset($_POST['add_type']) && !empty($_POST['add_type'])) {
    ...
    if(empty($course_type) ) {
        ...
        $result = $zenta_operation->add_course_type($course_type, $gallery, $admin_id);
        if($result) {
             $message_success = "Course type was added successfully.";
        } else {
            $message_error = "Course type was not added.";
        }
    }
}
 ?><!DOCTYPE html>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                 							<?php include_once('views/add_course_type.php');?>
                                                        </div>
                                                    </div>
                                                </div>
