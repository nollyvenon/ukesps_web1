...
$del_users = $zenta_operation->del_course_subcategory($id_encrypted);
if ($del_users) {
	$message_success = "You have successfully deleted the course subcategory's data";
} else {
	$message_error = "Something went wrong. Please try again.";
}
header("Location:manage_course_subcategory");
