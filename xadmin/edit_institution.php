...
if (isset($_POST['edit_institute']) && !empty($_POST['edit_institute'])) {
    ...
    if(empty($location)) {
        ...
        $result = $zenta_operation->update_institution($token, $institution, $location_id, $state_id, $country_id, $admin_id);
        if($result) {
             $message_success = "Institution was edited successfully.";
        } else {
            $message_error = "Institution was not edited successfully.";
        }
    }
}
 ?><!DOCTYPE html>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                 							<?php include_once('views/edit_institution.php');?>
                                                        </div>
                                                    </div>
                                                </div>
