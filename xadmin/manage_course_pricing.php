                                ...
                                <?php if (isset($content) && !empty($content)) {
                                  foreach ($content as $row) { ?>
                                    <tr>
                                      ...
                                      <td><a class="btn btn-border green" href="update_course_pricing.php?action=view&sid=<?php echo $row['event_id']; ?>"><span> Update</span></a>
                                        <a class="btn btn-border dark" href="del_course_pricing.php?action=view&sid=<?php echo $row['event_id']; ?>"><span> Delete</span></a></td>
                                    </tr>
                                <?php }
                                } else {
