<?php
$page_title = 'Manage Course Types';
$page_group = 'Admin';
...
if(isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
	...
	$query = "SELECT cou.* FROM course_types cou WHERE cou.type_name LIKE '%$search_text%' ORDER BY cou.type_id DESC ";
} else {
	$query = "SELECT * FROM course_types order by type_id DESC ";
}
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <?php include_once('views/manage_course_types.php');?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
