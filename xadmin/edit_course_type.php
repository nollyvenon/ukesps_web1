...
if (isset($_POST['edit_type']) && !empty($_POST['edit_type'])) {
    $course_type = $db_handle->sanitizePost($_POST['course_type']);
	$uploaddir = "../img/course_type/";
    ...
    if(empty($course_type) ) {
        ...
        $result = $zenta_operation->edit_course_type($token, $course_type, $gallery, $admin_id);
		
        if($result) {
             $message_success = "Course type was added successfully.";
        } else {
            $message_error = "Course type was not added successfully.";
        }
    }
}
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                 							<?php include_once('views/edit_course_type.php');?>
                                                        </div>
                                                    </div>
                                                </div>
