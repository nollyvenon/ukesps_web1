...
if (!in_array(22, $my_pages)) {
	...
	$del_users = $zenta_operation->del_course_type($id_encrypted);
	if ($del_users){
		 $message_success = "You have successfully deleted the course type's data";
	} else {
		$message_error = "Something went wrong. Please try again.";
	}
	header("Location:manage_course_type");
