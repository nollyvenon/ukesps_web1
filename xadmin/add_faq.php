...
if (isset($_POST['add_faq']) && !empty($_POST['add_faq'])) {
  ...
  if (empty($question) || empty($answer)) {
    ...
    $result = $zenta_operation->add_faq($question, $answer);
    if ($result) {
      $message_success = "Faq was added successfully.";
      header("Location:manage_faqs.php");
    } else {
      $message_error = "Faq was not added successfully.";
    }
  }
}
                        ...
                        <div class="card">
                          ...
                          <div class="card-block">
                            <div class="dt-responsive table-responsive">
                              <?php include_once('views/add_faq.php'); ?>
                            </div>
                          </div>
                        </div>
