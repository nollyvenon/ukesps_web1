...
if (isset($_POST['add_job']) && !empty($_POST['add_job'])) {
    ...
    $job_company = $db_handle->sanitizePost($_POST['job_company']);
    ...
    if(empty($course_title) || empty($location) || empty($description)) {
        ...
        $result = $zenta_operation->add_job($job_title, $recruiter_code, $email, $phone, $gallery, $job_company, $location_id, $country_id, $startDate, $endDate, $category_id, $sub_category_id, $jobstype, $joblevel, $jobsector, $description);
        if($result) {
...
$job_sectors = $zenta_operation->get_job_sector();
$job_locations = $zenta_operation->manage_job_locations();
 ?><!DOCTYPE html>
<html lang="en">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                 							<?php include_once('views/add_job.php');?>
                                                        </div>
                                                    </div>
                                                </div>
