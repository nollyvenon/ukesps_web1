...
if (isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
  ...
  $query = "SELECT * FROM faqs WHERE id LIKE '%$search_text%' OR event_title LIKE '%$search_text%'  ORDER BY id DESC ";
} else {
                                ...
                                <?php if (isset($content) && !empty($content)) {
                                  foreach ($content as $row) { ?>
                                    <tr>
                                      ...
                                      <td><?php echo limit_text($row['answer'], $limit); ?></td>
                                      <td><a class="btn btn-border green" href="update_faq.php?action=view&sid=<?php echo $row['id']; ?>"><span> Update</span></a>
                                        <a class="btn btn-border dark" href="del_faq.php?action=view&sid=<?php echo $row['id']; ?>"><span> Delete</span></a></td>
                                    </tr>
                                <?php }
                                } else {
