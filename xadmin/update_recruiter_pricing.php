...
$page_title = 'Update Recruiter Pricing';
$page_group = 'Admin';
...
$sidi = $_GET['sid'];
$content = $zenta_operation->get_recruiter_pricing_detail($sidi);
extract($content);

if (isset($_POST['update_recruiter_pricing']) && !empty($_POST['update_recruiter_pricing'])) {
  ...
  if (empty($plan_name) || empty($plan_cost) || empty($description)) {
    ...
    $result = $zenta_operation->update_recruiter_pricing($sidi, $plan_name, $plan_cost, $plan_discount, $course_plan_currency, $gallery, $plan_period, $plan_highlights, $description);
    if ($result) {
      $message_success = "Recruiter Pricing was updated successfully.";
      header("Location:manage_job_pricings.php");
    } else {
      $message_error = "Recruiter Pricing was not updated successfully.";
    }
  }
}
                        ...
                        <div class="card">
                          ...
                          <div class="card-block">
                            <div class="dt-responsive table-responsive">
                              <?php include_once('views/update_recruiter_pricing.php'); ?>
                            </div>
                          </div>
                        </div>
