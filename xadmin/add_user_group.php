...
$page_group = 'User group';
require_once("../includes/initialize_admin.php");
if (!$session_admin->is_logged_in()) {
    redirect_to("log-in");
}
if (!in_array(25, $my_pages)) {
...
if ($_POST['create_group']){
    ...
    extract($_POST);
	   ...
	   if ($userfile != ""){
	   		$userfile  = time().$_FILES['userfile']['name'];
		}
		
	if ($group_name != ""){
		$group_name = str_replace(" ","_",$group_name);
		$add_warehouse = $zenta_operation->add_user_group($group_name, $description);
		$message_success = "User Group added successfully";
	}else{
		$message_error = "Complete all fields";	
	}
}
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                 						<?php include_once('views/add_user_group.php');?>
                                                    </div>
                                                </div>
