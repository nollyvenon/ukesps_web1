...
//  }
// $hiss = $_GET['id'];
$user_list = $zenta_operation->event_providers();

if (isset($_GET['did'])) {
  $del_users = $zenta_operation->del_eventprovider($_GET['did']);
  if ($del_users) {
    $message_success = "You have successfully deleted the user's data";
  } else {
    $message_error = "Something went wrong. Please try again.";
  }
  header("Location:event_providers.php");
} else if (isset($_GET['act'])) {
  $del_users = $zenta_operation->activate_event_provider($_GET['act']);
  if ($del_users) {
    $message_success = "You have successfully deleted the user's data";
  } else {
    $message_error = "Something went wrong. Please try again.";
  ...
  $del_users = $zenta_operation->deactivate_event_provider($_GET['deact']);
  if ($del_users) {
    $message_success = "You have successfully deleted the user's data";
  } else {
    $message_error = "Something went wrong. Please try again.";
                        ...
                        <div class="card">
                          ...
                          <div class="card-block">
                            <div class="dt-responsive table-responsive">
                              <?php include_once('views/event_providers.php'); ?>
                            </div>
                          </div>
                        </div>
                      </div>
