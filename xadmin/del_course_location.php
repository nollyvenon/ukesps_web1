...
if (!in_array(22, $my_pages)) {
	...
	$del_users = $zenta_operation->del_course_location($id_encrypted);
	if ($del_users){
		 $message_success = "You have successfully deleted the course location data";
	} else {
		$message_error = "Something went wrong. Please try again.";
	}
	header("Location:manae_course_locations");
