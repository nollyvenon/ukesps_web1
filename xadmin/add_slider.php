...
if (isset($_POST['add_slider'])) {
  ...
  if (empty($sub_title) || empty($title) || empty($_FILES['image'])) {
    ...
    if (!move_uploaded_file($_FILES['image']['tmp_name'], SITE_ROOT . '/img/sliders/' . $image)) {
      ...
      $result = $zenta_operation->add_slider($title, $sub_title, $image);
      if ($result) {
        $message_success = "Slider was successfully added.";
        $title = '';
        $sub_title = '';
        // header("Location:manage_sliders.php");
      } else {
        $message_error = "Slider was not successfully added.";
      }
    }
  }
}
                        ...
                        <div class="card">
                          ...
                          <div class="card-block">
                            <div class="dt-responsive table-responsive">
                              <?php include_once('views/add_slider.php'); ?>
                            </div>
                          </div>
                        </div>
                      </div>
