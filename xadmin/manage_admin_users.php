...
if ($user_group[0]['accounttype'] !== '1') {
  $message_error .= "You do not have right to that page or feature. Regards.";
  redirect_to("dashboard?msg=10");
}
// $hiss = $_GET['id'];
$user_list = $admin_object->get_all_admin();

if (isset($_GET['did'])) {
  $del_users = $admin_object->delete_user($_GET['did']);
  if ($del_users) {
  ...
  $del_users = $admin_object->activate_user($_GET['act']);
  if ($del_users) {
    $message_success = "You have successfully deleted the user's data";
  } else {
    $message_error = "Something went wrong. Please try again.";
  ...
  $del_users = $admin_object->deactivate_user($_GET['deact']);
  if ($del_users) {
    $message_success = "You have successfully deleted the user's data";
  } else {
    $message_error = "Something went wrong. Please try again.";
                        ...
                        <div class="card">
                          ...
                          <div class="card-block">
                            <div class="dt-responsive table-responsive">
                              <?php include_once('views/admin_users.php'); ?>
                            </div>
                          </div>
                        </div>
                      </div>
