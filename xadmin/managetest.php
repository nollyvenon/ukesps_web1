...
if(isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
	...
	$query = "SELECT * FROM testimonials WHERE testi_id LIKE '%$search_text%' OR quote LIKE '%$search_text%' OR quote_writer LIKE '%$search_text%' ORDER BY testi_id DESC ";
} else {
	$query = "SELECT * FROM testimonials order by testi_id DESC ";
}
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['quote_writer']; ?></td>
                                            <td><?php echo $row['quote']; ?></td>
                                            <td><?php echo $row['quote_location']; ?></td>
                                            <td><a class="btn btn-border green" href="updatetesti.php?action=view&id=<?php echo $row['testi_id']; ?>"><span> Update</span></a>
                                            <a class="btn btn-border dark" href="deletetesti.php?action=view&id=<?php echo $row['testi_id']; ?>"><span> Delete</span></a></td>
                                        </tr>
