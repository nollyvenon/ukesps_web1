...
$page_title = 'Update Course Pricing';
$page_group = 'Admin';
...
$sidi = $_GET['sid'];
$content = $zenta_operation->get_course_pricing_detail($sidi);
extract($content);

if (isset($_POST['update_course_pricing']) && !empty($_POST['update_course_pricing'])) {
  ...
  if (empty($plan_name) || empty($plan_cost) || empty($description)) {
    ...
    $result = $zenta_operation->update_course_pricing($sidi, $plan_name, $plan_cost, $plan_discount, $course_plan_currency, $gallery, $plan_period, $plan_highlights, $description);
    if ($result) {
      $message_success = "Course Pricing was updated successfully.";
      header("Location:manage_course_pricings.php");
    } else {
      $message_error = "Course Pricing was not updated successfully.";
    }
  }
}
                        ...
                        <div class="card">
                          ...
                          <div class="card-block">
                            <div class="dt-responsive table-responsive">
                              <?php include_once('views/update_course_pricing.php'); ?>
                            </div>
                          </div>
                        </div>
