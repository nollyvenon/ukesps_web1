 <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
 		...
 		<div class="col-md-6">
 			...
 			<select name="course_currency" required data-required="true" class="form-control" data-live-search="true">
 				...
 				<?php
					...
					?>
 					<option <?php if ($course_currency == $row44['currency_code']) {
											echo 'selected';
										}  ?> value="<?php echo $row44['currency_code']; ?>">
 			...
 			<div class='input-group'>
 				<select name="location" data-required="true" class="form-control" data-live-search="true">
 					...
 					<?php
						...
						?>
 						<option <?php if ($location == $row2['location_id']) {
												echo 'selected';
											}  ?> value="<?php echo $row2['location_id']; ?>">
 		...
 		<div class="col-md-6">
 			...
 			<select name="course_type" data-required="true" class="form-control" data-live-search="true">
 				...
 				<?php
					...
					?>
 					<option <?php if ($course_type == $row2['type_id']) {
											echo 'selected';
										}  ?> value="<?php echo $row2['type_id']; ?>">
 		...
 		<div class="col-md-6">
 			...
 			<select name="category_id" data-required="true" onfocus="ShowPageLoc(this.value)" onchange="ShowPageLoc(this.value)" class="form-control" data-live-search="true">
 				...
 				<?php
					...
					?>
 					<option <?php if ($course_category == $row2['category_id']) {
											echo 'selected';
 			...
 			<div id="txtHint1">
 				<select name="sub_category_id" data-required="true" class="form-control" data-live-search="true">
 					...
 					<?php
						...
						?>
 						<option <?php if ($course_subcategory == $row3['subcat_id']) {
												echo 'selected';
											} ?> value="<?php echo $row3['subcat_id']; ?>">
 		...
 		<div class="col-md-6">
 			...
 			<select name="study_method" data-required="true" class="form-control" data-live-search="true">
 				...
 				<?php
					...
					?>
 					<option <?php if ($study_method == $row2['csm_id']) {
											echo 'selected';
										} ?> value="<?php echo $row2['csm_id']; ?>">
 						<?php echo $row2['cs_method']; ?>
 					</option>
 				<?php
					endforeach;
					?>
 		...
 		<div class="col-md-6">
 			...
 			<select name="study_level" data-required="true" class="form-control" data-live-search="true">
 				...
 				<?php
					...
					?>
 					<option <?php if ($study_level == $row2['sl_id']) {
											echo 'selected';
										} ?> value="<?php echo $row2['sl_id']; ?>">
 		...
 		<div class="col-md-6">
 			...
 			<select name="course_institute" required data-required="true" class="form-control" data-live-search="true">
 				...
 				<?php
					...
					?>
 					<option <?php if ($course_institute == $row44['institute_id']) {
											echo 'selected';
										} ?> value="<?php echo $row44['institute_id']; ?>">
 	...
 	<div class="row m-b-20">
 		...
 		<div class="col-md-12">
 			<label for="course_structure" class="control-label">Course Outline</label>
 			<textarea id="course_structure" name="course_structure" rows="15" cols="40"><?php echo $course_structure; ?></textarea>
 			<script>
 				// Replace the <textarea id="editor1"> with a CKEditor
 				// instance, using default configuration.
 				CKEDITOR.replace('course_structure', {
 					filebrowserBrowseUrl: 'filemanager/dialog.php?type=2&editor=ckeditor&fldr=',
 					filebrowserUploadUrl: 'filemanager/dialog.php?type=2&editor=ckeditor&fldr=',
 					"filebrowserImageUploadUrl": "ckeditor/plugins/imgupload/imgupload.php"
 				});
 		...
 		<div class="col-md-12">
 			<label for="apply_info" class="control-label">Application Info</label>
 			<textarea id="apply_info" name="apply_info" rows="15" cols="40"><?php echo $apply_info; ?></textarea>
 			<script>
 				// Replace the <textarea id="editor1"> with a CKEditor
 				// instance, using default configuration.
