...
<?php require_once '../layouts/feedback_message.php'; ?>
	<input type="hidden" name="token" value="<?php echo $hiss;?>" />
								<div class="row m-b-20">
                                    <div class="col-md-8">
 										<label for="user_code" class="control-label">Course Type</label>
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
										<input name="edit_type" type="submit"  class="btn btn-primary btn-md waves-effect text-center m-b-20" value="Update Course Type">
                                    </div>
                                </div>
</form>