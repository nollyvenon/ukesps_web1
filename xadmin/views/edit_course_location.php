 <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
 	...
 	<div class="row ">
 		...
 		<div class="col-md-6 m-b-20">
 			...
 			<select name="country_id" onfocus="ShowStatebyCountry(this.value)" required onchange="ShowStatebyCountry(this.value)" data-required="true" class="form-control selectpicker" data-live-search="true">
