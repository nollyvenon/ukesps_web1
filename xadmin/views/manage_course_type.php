                                ...
                                <table class="table ttable-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-border green" href="edit_course_type?hiss=<?php echo encrypt($row['type_id']); ?>"><span> <i class="fa fa-edit"></i></span></a>
                                            <a class="btn btn-border dark" href="del_course_type.php?hiss=<?php echo encrypt($row['type_id']); ?>"><span> <i class="fa fa-trash"></i></span></a>
											</td>
                                        </tr>
