	...
	<input type="hidden" name="token" value="<?php echo $hiss;?>" />
		...
		<div class="row m-b-20">
              ...
              <select name="course_category" data-required="true" class="form-control" data-live-search= "true">
										...
										?>
                                    		<option <?php if ($category_parent == $row2['category_id']){ echo 'selected';}  ?> value="<?php echo $row2['category_id'];?>">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
										<input name="add_course" type="submit"  class="btn btn-primary btn-md waves-effect text-center m-b-20" value="Update Course Sub Category">
                                    </div>
                                </div>
</form>