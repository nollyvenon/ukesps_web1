 <form action="" method="post" class="form-horizontal tasi-form" enctype="multipart/form-data">
   ...
   <div class="row m-b-20">
     ...
     <div class="col-md-12">
       ...
       <textarea id="answer" name="answer" rows="15" cols="40"><?= $answer ?></textarea>
       <script>
   ...
   <div class="row m-t-30">
     <div class="col-md-12">
       ...
       <input name="update_faq" type="submit" class="btn btn-primary btn-md waves-effect text-center m-b-20" value="Update Faq">
     </div>
   </div>
 </form>