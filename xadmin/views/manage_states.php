                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-border green" href="edit_state?hiss=<?php echo encrypt($row['state_id']); ?>"><span> <i class="fa fa-edit"></i></span></a>
                                            <a class="btn btn-border dark" href="del_state.php?hiss=<?php echo encrypt($row['state_id']); ?>"><span> <i class="fa fa-trash"></i></span></a>
											</td>
                                        </tr>
