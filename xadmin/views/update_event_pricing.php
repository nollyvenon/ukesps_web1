<form action="" method="post" class="form-horizontal tasi-form" enctype="multipart/form-data">
  ...
  <div class="row m-b-20">
    ...
    <div class="col-md-6">
      ...
      <select name="course_plan_currency" required data-required="true" class="form-control" data-live-search="true">
        ...
        ?>
          <option <?= $row44['currency_code'] == $content['plan_curency'] ? "selected" : "" ?> value="<?php echo $row44['currency_code']; ?>">
  ...
  <div class="row m-t-30">
    <div class="col-md-12">
      <input name="update_event_pricing" type="submit" class="btn btn-primary btn-md waves-effect text-center m-b-20" value="Update Event Pricing">
    </div>
  </div>
</form>