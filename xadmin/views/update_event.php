...
<?php require_once '../layouts/feedback_message.php'; ?>
								<div class="row m-b-20">
	 							...
	 							<div class="row m-b-20">
                                    <div class="col-md-6">
 										<label for="user_code" class="control-label">Event Image</label>
	 ...
	 <label for="payment_method" class="control-label">Event Date</label>
	 							<div class="row m-b-20">
											...
											<div class="col-md-4">
												Start Date: <input id="startDate"  value="<?php echo $startDate;?>"  class="form-control" />
											</div>
											<div class="col-md-4">
        End Date: <input id="endDate"  value="<?php echo $endDate;?>" class="form-control" />
											 </div>
                                    ...
                                    <div class="col-md-6">
 										<label for="location" class="control-label">Events Location</label>
											<div class='input-group'>
												<input id="location" name="location" type='text' value="<?php echo $location;?>" class="form-control" />
												</span>
											</div>
                                    </div>
	 								<div class="col-md-6">
 										<label for="summary" class="control-label">Events Summary</label>
										<textarea id="summary" name="summary" rows="5" cols="40"> value="<?php echo $summary;?>"</textarea>
										<script>
  ...
  "filebrowserImageUploadUrl": "ckeditor/plugins/imgupload/imgupload.php"
									...
									<div class="col-md-12">
										...
										<textarea id="content" name="content" rows="15" cols="40"> value="<?php echo $content;?>"
