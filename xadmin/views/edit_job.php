	...
	<div class="form-group">
		...
		<div class="form-group">
              ...
              <div class="col-md-10 col-xs-11">
                 ...
                 <select name="job_level" required data-required="true" class="selectpicker" data-live-search= "true">
		...
		<div class="form-group">
              ...
              <div class="col-md-10 col-xs-11">
                 ...
                 <select name="job_sector" required data-required="true" class="selectpicker" data-live-search= "true">
		...
		<div class="form-group">
              ...
              <div class="col-md-10 col-xs-11">
                ...
                <select name="location_id" required data-required="true" class="selectpicker" data-live-search= "true">
              ...
              <div class="col-md-10 col-xs-11"><select name="country_id" required data-required="true" class="selectpicker" data-live-search= "true">
              ...
              <div class="col-md-10 col-xs-11"><select name="category_id"  required onfocus="ShowSubCategories(this.value)" onchange="ShowSubCategories(this.value)" data-required="true" class="selectpicker" data-live-search= "true">
			...
			<div class="form-group">
              ...
              <div class="col-md-10 col-xs-11"><div id="txtHint1"><select name="sub_category_id" required data-required="true" class="selectpicker" data-live-search= "true">
