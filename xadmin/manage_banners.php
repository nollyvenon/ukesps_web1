...
$page_title = 'Mange Banners';
$page_group = 'Banners and Ads';
$User_Type = 'Admin';
if (isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
  $search_text = $_POST['search_text'];
  $query = "SELECT * FROM banners_and_ads WHERE title LIKE '%$search_text%' OR position LIKE '%$search_text%' ORDER BY id DESC ";
} else {
  $query = "SELECT * FROM banners_and_ads order by id DESC ";
}
                        ...
                        <div class="card">
                          ...
                          <div class="card-block">
                            <div class="dt-responsive table-responsive">
                              <?php include_once('views/manage_banners.php'); ?>
                            </div>
                          </div>
                        </div>
                      </div>
