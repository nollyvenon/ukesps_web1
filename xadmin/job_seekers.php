...
//  }
// $hiss = $_GET['id'];
$user_list = $zenta_operation->job_seekers();

if (isset($_GET['did'])) {
  $del_users = $zenta_operation->del_jobseeker($_GET['did']);
  if ($del_users) {
  ...
  $del_users = $zenta_operation->activate_job_seeker($_GET['act']);
  if ($del_users) {
    $message_success = "You have successfully deleted the user's data";
  } else {
    $message_error = "Something went wrong. Please try again.";
  ...
  $del_users = $zenta_operation->deactivate_job_seeker($_GET['deact']);
  if ($del_users) {
    $message_success = "You have successfully deleted the user's data";
  } else {
    $message_error = "Something went wrong. Please try again.";
                        ...
                        <div class="card">
                          ...
                          <div class="card-block">
                            <div class="dt-responsive table-responsive">
                              <?php include_once('views/job_seekers.php'); ?>
                            </div>
                          </div>
                        </div>
                      </div>
