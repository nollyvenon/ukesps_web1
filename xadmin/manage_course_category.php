<?php
$page_title = 'Manage Course Category';
$page_group = 'Admin';
...
if (isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
    ...
    $query = "SELECT cou.* FROM course_categories cou WHERE cou.category_name LIKE '%$search_text%' ORDER BY cou.category_id DESC ";
} else {
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <?php include_once('views/manage_course_category.php'); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
