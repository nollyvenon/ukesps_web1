...
$page_title = 'Manage Course Pricing';
$page_group = 'Course Pricing';
$limit = 10;

if (isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
  $search_text = $_POST['search_text'];
  $query = "SELECT * FROM course_provider_plans WHERE plan_id LIKE '%$search_text%' OR plan_name LIKE '%$search_text%'  ORDER BY plan_id DESC ";
} else {
                                ...
                                <?php if (isset($content) && !empty($content)) {
                                  foreach ($content as $row) { ?>
                                    <tr>
                                      ...
                                      <td><a class="btn btn-border green" title="Edit Course Pricing" href="update_course_pricing.php?action=view&sid=<?php echo $row['plan_id']; ?>"><i class="fa fa-edit"></i></a>
                                        <a class="btn btn-border dark" title="Delete Course Pricing" href="del_course_pricing.php?action=view&sid=<?php echo $row['plan_id']; ?>"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                <?php }
                                } else {
