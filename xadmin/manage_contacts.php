<?php
$page_title = 'Manage Contacts And Appointments';
$page_group = 'Contacts And Appointments';
$User_Type = 'Admin';
...
// $hiss = $_GET['id'];
$contacts = $zenta_operation->get_contacts();

if (isset($_GET['did'])) {
  $del_contact = $zenta_operation->delete_contact($_GET['did']);
                        ...
                        <div class="card">
                          ...
                          <div class="card-block">
                            <div class="dt-responsive table-responsive">
                              <?php include_once('views/manage_contacts.php'); ?>
                            </div>
                          </div>
                        </div>
                      </div>
