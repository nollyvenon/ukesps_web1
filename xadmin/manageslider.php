...
if(isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
	...
	$query = "SELECT * FROM sliderpix WHERE title LIKE '%$search_text%' OR picture LIKE '%$search_text%' ORDER BY id DESC ";
} else {
	$query = "SELECT * FROM sliderpix order by id DESC ";
}
                                ...
                                <table class="table table-responsive table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="../img/slides/<?php echo $row['picture'];?>" width=100 height=100></td>
                                            <td><a class="btn btn-border dark" href="deleteslider.php?action=view&id=<?php echo $row['id']; ?>"><span> Delete</span></a></td>
                                        </tr>
