...
$id = $_GET['id'];
$content = $bio_operation->get_team_by_id($id);
extract($content);

if (isset($_POST['editteam']) && !empty($_POST['editteam'])) {
    ...
    if(empty($name) || empty($position) ) {
        ...
        $result = $bio_operation->updateteammember($name, $position, $introtext);
        if($result) {
...
tinymce.init({
   ...
   style_formats: [
        ...
        <script type="text/javascript" src="file:///C|/wamp/www/datetimepicker_css.js"></script>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label for="position">
                                Position</label>
                            <input name="position" type="text" id="position" value="<?php echo $position; ?>" size="73" />
                        </div>
                        <div class="form-group">
                            <label for="introtext">
                                About Info</label>
                            <textarea name="introtext" id="introtext" rows="3"><?php echo $introtext; ?></textarea>
                        </div>                                                
                    <div class="col-md-12">
                            <input type="submit" class="btn btn-primary" name="editteam"  value="Add Member" />
