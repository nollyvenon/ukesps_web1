...
$position = "";
$bid = $_GET['id'];
$banner = $zenta_operation->getBanner($bid);
extract($banner);
if (isset($_POST['update_banner'])) {
  ...
  if (empty($position) || empty($title)) {
    ...
    if ($_FILES['image']['name'] == NULL) {
      // var_dump($banner_url);
      // die();
      $result = $zenta_operation->update_banner($bid, $title, $position, $image, $banner_url, $updated_at);
      if ($result) {
        $message_success = "Banner was successfully updated.";
        header("Location:manage_banners.php");
      } else {
        $message_error = "Banner was not successfully updated.";
      }
    } else {
                        ...
                        <div class="card">
                          ...
                          <div class="card-block">
                            <div class="dt-responsive table-responsive">
                              <?php include_once('views/updatebanner.php'); ?>
                            </div>
                          </div>
                        </div>
                      </div>
