...
// $hiss = $_GET['id'];
$subscribers = $zenta_operation->get_subscriptions();

if (isset($_GET['did'])) {
  $del_users = $zenta_operation->delete_subscriber($_GET['did']);
  if ($del_users) {
    $message_success = "You have successfully deleted the user's email";
  } else {
                        ...
                        <div class="card">
                          ...
                          <div class="card-block">
                            <div class="dt-responsive table-responsive">
                              <?php include_once('views/manage_subscribers.php'); ?>
                            </div>
                          </div>
                        </div>
                      </div>
