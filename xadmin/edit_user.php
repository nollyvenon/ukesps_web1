...
if ($_POST['edit_user']){
	...
	if ($first_name != "" and $last_name != "" and $username != ""){
        ...
        $upd_emp = $zenta_operation->edit_admin($token, $first_name, $last_name, $gender, $phone, $email, $username, $status, '', $accounttype);
			if($upd_emp) {
				$message_success = "You have successfully edited the user";
...
$users_det = $admin_object->get_admin_detail_by_id($hiss);
extract($users_det);
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                 						<?php include_once('views/edit_user.php');?>
                                                    </div>
                                                </div>
