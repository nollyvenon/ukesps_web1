...
$grp_info = $zenta_operation->get_group_by_id($hiss);
extract($grp_info);
if ($_POST['edit_group']){
	...
	if ($group_name != ""){
		...
		$zenta_operation->edit_group($hiss, $group_name, $description);
		$message_success = "Group updated successfully";
	}else{
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                 						<?php include_once('views/edit_user_group.php');?>
                                                    </div>
                                                </div>
