...
//  }
// $hiss = $_GET['id'];
$user_list = $zenta_operation->recruiters();

if (isset($_GET['did'])) {
  $del_users = $zenta_operation->del_recruiter($_GET['did']);
  if ($del_users) {
  ...
  $del_users = $zenta_operation->activate_recruiter($_GET['act']);
  if ($del_users) {
    $message_success = "You have successfully deleted the user's data";
  } else {
    $message_error = "Something went wrong. Please try again.";
  ...
  $del_users = $zenta_operation->deactivate_recruiter($_GET['deact']);
  if ($del_users) {
    $message_success = "You have successfully deleted the user's data";
  } else {
    $message_error = "Something went wrong. Please try again.";
                        ...
                        <div class="card">
                          ...
                          <div class="card-block">
                            <div class="dt-responsive table-responsive">
                              <?php include_once('views/recruiters.php'); ?>
                            </div>
                          </div>
                        </div>
                      </div>
