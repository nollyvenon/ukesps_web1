...
if (isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
	...
	$query = "SELECT * FROM courses WHERE course_type='$cou_type' AND course_title LIKE '%$search_text%' ORDER BY course_id DESC ";
} else {
	$query = "SELECT * FROM courses WHERE course_type='$cou_type' order by course_id DESC ";
}
					...
					?>
							...
							<div class="category-item list clear-fix">
								...
								<div class="category-info">
									<span class="price">
										<span class="amount">
											<?= $course_fees; ?><sup><?= $course_currency; ?></sup>
										</span>
										<span class="description-price"><?= $duration; ?></span>
									</span>
