...
class AdminUser
{
    ...
    public function add_new_admin($first_name = '', $last_name = '', $phone = '', $email, $username = '', $password, $accounttype = NULL)
    {
        global $db_handle;
        ...
        if ($db_handle->numRows("SELECT admin_code FROM admin WHERE admin_code = '$admin_code'") > 0) {
            goto admin_code;
        };
        ...
        $query = "INSERT INTO admin (admin_code, username, email, pass_salt, password, first_name, last_name, status, accounttype, phone ) VALUES ('$admin_code', '$username', '$email', '$pass_salt', '$gen_pass', '$first_name', '$last_name', '1', '$accounttype', '$phone')";
        ...
        if ($db_handle->affectedRows() > 0) {
            ...
            $subject = "UKESPS Admin Login";
            $body = "
Dear " . $first_name . "

A new Solar Tech Admin profile has been created for you.

Your system generated password is $gen_pass
...
www.footballfansnetwork.com";
    ...
    public function activate_user($user_id)
    {
        ...
        $query = "UPDATE admin SET status = '1' WHERE admin_id='$user_id'";
        $result = $db_handle->runQuery($query);
    ...
    public function deactivate_user($user_id)
    {
        ...
        $query = "UPDATE admin SET status = '0' WHERE admin_id='$user_id'";
        $result = $db_handle->runQuery($query);
