...
$course_currency = $zenta_operation->get_course_by_id($_SESSION['cart'][0])['course_currency'];
?><!DOCTYPE HTML>
<html>
<head>
						 ...
						 <?php  if (!$session_client->is_logged_in()) { ?>  
							<div class="create-account">
								...
								<p class="validate-required" id="account_password_field">
									<label for="account_email" class="">Email
										<abbr class="required" title="required">*</abbr>
									</label>
									<input type="text" class="input-text " name="account_email" id="account_email" value="" />
								</p>
						...
						<p class="form-row form-row-wide address-field update_totals_on_change validate-required" id="billing_country_field">
							<p class="form-row form-row-wide checkbox">
								...
								<p class="form-row form-row-wide address-field validate-required" id="billing_city_field">
									...
									<input type="text" class="input-text " name="billing_city" id="billing_city" placeholder="Town / City" value="<?php echo $city;?>" />
								</p>
								<p class="form-row form-row-first address-field validate-required validate-state" id="billing_state_field">
									...
									<input type="text" class="input-text " value="<?php echo $state;?>" placeholder="" name="billing_state" id="billing_state" />
								</p>
								<div class="clear"></div>
								...
								<p class="form-row form-row-first validate-required validate-email" id="billing_password_field">
									<label for="billing_password" class="">Account password
										<abbr class="required" title="required">*</abbr>
									</label>
									<input type="password" class="input-text " name="billing_password" id="billing_password" value="" />
								</p>
								...
								<table>
									<tbody>
										...
										<tr class="cart-subtotal">
											<th>Cart Subtotal</th>
											<td><span class="amount"><?=$course_currency;?><?=$cart_total;?></span></td>
										</tr>
										<tr class="shipping">
