          ...
          <section class="clear-fix">
            ...
            <form action="" method="post">
              ...
              <div class="row m-t-30">
                <div class="col-md-12">
                  <input name="upload_resume" type="submit" class="btn btn-primary btn-md waves-effect text-center m-b-20" value="Upload Resume">
                </div>
              </div>
            </form>
            <hr>
                ...
                <form action="" method="post" class="form-horizontal tasi-form" enctype="multipart/form-data">
                  ...
                  <div class="row m-b-20">
                    <div class="col-md-6">
                      ...
                      <input type="text" class="form-control" id="plan_cost" name="plan_cost" value="">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class='input-group'>
                        <input id="plan_highlights" name="plan_highlights" type='text' class="form-control" value="" />
                        </span>
                      </div>
                    </div>
                  </div>
