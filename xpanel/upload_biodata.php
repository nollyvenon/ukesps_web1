...
if ($_POST['submit']){
	...
	$biodata = $client_operation->add_biodata($user_code, $resume,
	 $cover_letter, $place_of_birth, $location, $country_of_residence,
	  $country_of_nationality, $languages, $linked_profile, $twitter_profile,
	   $hobbies, $skills);
